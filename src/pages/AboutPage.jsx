      ...
      <Container maxWidth="lg" sx={{ py: { xs: 5, md: 8 } }}>
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary" lineHeight={2}>
            ...
            선택한 기능은 사용자가 켜고 끌 수 있습니다. 공모주·아파트 청약 일정은 <strong>로그인 후 캘린더 화면</strong>에서만 실제로 붙으며,
            PC는 왼쪽 영역(사이드바), 모바일은 상단 메뉴에서 각각 표시 여부를 전환합니다. 데이터를 긁어오려면 Open DART·공공데이터포털에서 발급한 키를
            프로젝트 환경 변수(Vite <code style={{ fontSize: '0.9em' }}>VITE_*</code>)로 넣고 빌드해야 하며, 자세한 이름은 .env.example을 참고하세요.
            <br /><br />
