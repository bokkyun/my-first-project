...
const FEATURES = [
  ...
  },
  {
    ...
    title: '국내기업 실적·정기공시',
    desc: '같은 Open DART 인증키로 분기보고서(A003), 사업보고서(A001), 거래소 잠정실적 공시(I001) 접수일을 캘린더에 겹쳐 볼 수 있습니다. 캘린더 사이드바에서「국내기업 분기, 사업보고서, 잠정실적 발표일」을 켜면 됩니다.',
  },
  {
...
const STEPS = [
  ...
  { step: '03', title: '청약·외부 일정 선택', desc: '캘린더 화면에서 공모주, 국내기업 실적·정기공시(DART), 아파트 청약 등 참고 표시를 켜거나 끕니다.' },
